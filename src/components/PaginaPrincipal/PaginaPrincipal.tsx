  ...
  return (
    <>
      ...
      <main className="container mx-auto px-4 py-8 mb-auto">
        <motion.h1
          className="text-4xl font-display mb-10 text-white"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div className="flex flex-wrap gap-4 items-end mb-14 justify-space-between">
          <div className="categorias-cartas flex flex-col w-1/3">
            ...
            >
              <option value="" className="text-white focus:font-display">
                Selecione Um Album
              </option>
              {todosAlbuns.map((album) => (
                <option
                  className="text-white tracking-wide focus:font-display"
                  key={album.album_key}
                  value={album.album_key}
                >
                  {album.album_name}
                </option>
              ))}
